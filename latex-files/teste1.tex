...
O site do abnTeX disponibiliza um instalador que fornece arquivos .cls, .sty e templates para o texlive, mas a instalação do pacote \textbf{texlive-full} no Linux dispensa essas instalações, basta usar os modelos.
